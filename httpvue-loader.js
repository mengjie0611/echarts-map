 ...
 * @Author: Mengjie
 * @Description:
 * @Date: 2022-04-19 09:40:06
 * @LastEditTime: 2022-04-19 09:40:07
 * @FilePath: /cmsmcapp/src/main/resources/static/js/vendor/httpvue-loader.js
 */
            ...
            beforeCreate: function() {
                ...
                for (var componentName in components) {
                    if (
                        ...
                        var componentURL =
                            '_baseURI' in this.$options ? resolveURL(this.$options._baseURI, comp.url) : comp.url;
